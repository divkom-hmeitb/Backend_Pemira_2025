...
export namespace Prisma {
  ...
  */
  ...
  export type VoterMinAggregateOutputType = {
    ...
    nim: string | null
    token: string | null
    isVoteCakahim: boolean | null
    kahimChoice: string | null
    isVoteCasenat: boolean | null
    senatorChoice: string | null
    votedDate: string | null
    votedTime: string | null
  ...
  export type VoterCountAggregateOutputType = {
    ...
    nim: number
    token: number
    isVoteCakahim: number
    kahimChoice: number
    isVoteCasenat: number
    senatorChoice: number
    votedDate: number
    votedTime: number
  ...
  export type VoterGroupByOutputType = {
    ...
    nim: string
    token: string
    isVoteCakahim: boolean
    kahimChoice: string | null
    isVoteCasenat: boolean
    senatorChoice: string | null
    votedDate: string | null
    votedTime: string | null
    cloudinaryUrl: string | null
  ...
  export type VoterOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "name" | "nim" | "token" | "isVoteCakahim" | "kahimChoice" | "isVoteCasenat" | "senatorChoice" | "votedDate" | "votedTime" | "cloudinaryUrl" | "createdAt", ExtArgs["result"]["voter"]>
  ...
  interface VoterFieldRefs {
    ...
    readonly token: FieldRef<"Voter", 'String'>
    readonly isVoteCakahim: FieldRef<"Voter", 'Boolean'>
    readonly kahimChoice: FieldRef<"Voter", 'String'>
    readonly isVoteCasenat: FieldRef<"Voter", 'Boolean'>
    readonly senatorChoice: FieldRef<"Voter", 'String'>
    readonly votedDate: FieldRef<"Voter", 'String'>
    readonly votedTime: FieldRef<"Voter", 'String'>
    readonly cloudinaryUrl: FieldRef<"Voter", 'String'>
  ...
  export const VoterScalarFieldEnum: {
    ...
    nim: 'nim',
    token: 'token',
    isVoteCakahim: 'isVoteCakahim',
    kahimChoice: 'kahimChoice',
    isVoteCasenat: 'isVoteCasenat',
    senatorChoice: 'senatorChoice',
    votedDate: 'votedDate',
    votedTime: 'votedTime',
  ...
  export type VoterWhereInput = {
    ...
    token?: StringFilter<"Voter"> | string
    isVoteCakahim?: BoolFilter<"Voter"> | boolean
    kahimChoice?: StringNullableFilter<"Voter"> | string | null
    isVoteCasenat?: BoolFilter<"Voter"> | boolean
    senatorChoice?: StringNullableFilter<"Voter"> | string | null
    votedDate?: StringNullableFilter<"Voter"> | string | null
    votedTime?: StringNullableFilter<"Voter"> | string | null
    cloudinaryUrl?: StringNullableFilter<"Voter"> | string | null
  ...
  export type VoterOrderByWithRelationInput = {
    ...
    nim?: SortOrder
    token?: SortOrder
    isVoteCakahim?: SortOrder
    kahimChoice?: SortOrderInput | SortOrder
    isVoteCasenat?: SortOrder
    senatorChoice?: SortOrderInput | SortOrder
    votedDate?: SortOrderInput | SortOrder
    votedTime?: SortOrderInput | SortOrder
  ...
  export type VoterScalarWhereWithAggregatesInput = {
    ...
    token?: StringWithAggregatesFilter<"Voter"> | string
    isVoteCakahim?: BoolWithAggregatesFilter<"Voter"> | boolean
    kahimChoice?: StringNullableWithAggregatesFilter<"Voter"> | string | null
    isVoteCasenat?: BoolWithAggregatesFilter<"Voter"> | boolean
    senatorChoice?: StringNullableWithAggregatesFilter<"Voter"> | string | null
    votedDate?: StringNullableWithAggregatesFilter<"Voter"> | string | null
    votedTime?: StringNullableWithAggregatesFilter<"Voter"> | string | null
    cloudinaryUrl?: StringNullableWithAggregatesFilter<"Voter"> | string | null
  ...
  export type VoterUpdateInput = {
    ...
    isVoteCakahim?: BoolFieldUpdateOperationsInput | boolean
    kahimChoice?: NullableStringFieldUpdateOperationsInput | string | null
    isVoteCasenat?: BoolFieldUpdateOperationsInput | boolean
    senatorChoice?: NullableStringFieldUpdateOperationsInput | string | null
    votedDate?: NullableStringFieldUpdateOperationsInput | string | null
    votedTime?: NullableStringFieldUpdateOperationsInput | string | null
  ...
  export type VoterCountOrderByAggregateInput = {
    ...
    token?: SortOrder
    isVoteCakahim?: SortOrder
    kahimChoice?: SortOrder
    isVoteCasenat?: SortOrder
    senatorChoice?: SortOrder
    votedDate?: SortOrder
    votedTime?: SortOrder
